...
lon_min = -10
lon_max = 0           # If the region spans the Pacific meridian, max < min
        ...
        for season in list(range(4)):
            for lat in lats:
                for lon in lons:
                    ...
                    season_tally.at[row, 'total_obs'] = season_tally.loc[row]['total_obs'] + tally_all_obs_season
                    season_tally.at[row, 'fog_obs'] = (season_tally.loc[row]['fog_obs']) + tally_fog_obs_season
                    print(tally_all_obs_season, tally_fog_obs_season, season_tally.loc[row,'total_obs'], season_tally.loc[row,'fog_obs'])
                    row += 1
